...
* v_mul_i32
*
* Return the vector multiplication of input0 and input1.
* */
static inline __m128i v_mul_i32(__m128i input0, __m128i input1)
{
    ...
    // return summed products NOTE: some optimisations not yet considered
...
* vectori128_sum
*
* Compute and return the sum of vectors input0 and input1.
 */
...
* vectori128_min
*
* Compute and return the minimum of vector v, as a uniform vector of the result.
*/
...
* vectori128_dot
*
* Compute and return the dot product of input0 and input1, as a single integer.
*/
...
*
* Compute and return the dot product of input0 and input1, as a uniform vector of the result.
*/
