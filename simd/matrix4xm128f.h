...
*
* Compute and return the matrix-vector product of mat and vec.
*/
...
* mat4xm128_transpose
*
* Compute the matrix transposition of input, storing the result in out.
*/
...
/*
* mat4xm128_outer_product
*
* Compute the outer product of vec4s input1 and input2, storing the result in out.
*/
...
* mat4xm128_add
*
* Compute the matrix addition of input0 and input1, storing the result in out.
*/
...
* mat4xm128_mul
*
* Compute the matrix mutliplication of input0 and input1, storing the result in out.
*/
...
* mat4xm128_vec4_mul
*
* Compute and return the matrix vector-mutliplication of vec and mat.
*/
...
/*
* mat4xm128_rotation_mul
*
* Compute and return the mutliplication variation for rotation of matrices input and rotation,
...
* mat4xm128_rotate
*
* Compute and return the rotation of input over axis by angle radians, storing the result in
* rotation. We define this function for the case where the platform supports FMA instructions
...
* mat4xm128_translate
*
* Compute the translation of input with vector, storing the result in out.
*/
